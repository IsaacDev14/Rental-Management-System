...
const Sidebar: React.FC<SidebarProps> = ({ navigation, activeItem, setActiveItem }) => {
  ...
  return (
    <aside className="w-64 bg-gray-800 text-gray-300 flex flex-col flex-shrink-0 border-r border-gray-700 shadow-xl" aria-label="Sidebar Navigation">
      ...
      <footer className="px-4 py-6 border-t border-gray-700">
        <div className="flex items-center mb-4">
          <div
            ...
            aria-label={`User initial: ${DUMMY_USER.fullName.charAt(0).toUpperCase()}`}
          >
